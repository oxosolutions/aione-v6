	...
	<?php while ( have_posts() ) :  the_post(); ?>
		<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			<?php if( has_post_thumbnail() ): ?>
				<div class="oxo-events-featured-image">
					<div class="hover-type-<?php echo Aione()->settings->get( 'ec_hover_type' ); ?>">
						<!-- Event featured image, but exclude link -->
						<?php echo tribe_event_featured_image( $event_id, 'full', false ); ?>

						<?php Aione_EventsCalendar::render_single_event_title(); ?>
					</div>
			<?php else: ?>
				<div class="oxo-events-featured-image oxo-events-single-title">
					<?php Aione_EventsCalendar::render_single_event_title(); ?>
			<?php endif; ?>
				</div>
		...
		aione_render_social_sharing( 'events' );
