...
<div class="related-posts single-related-posts">
	<?php echo Aione()->template->title_template( sprintf( __( 'Related %s', 'tribe-events-calendar-pro' ), tribe_get_event_label_plural() ), '3' ); ?>
	...
	<ul class="tribe-related-events tribe-clearfix hfeed vcalendar">
		...
		<li>
			...
			<div class="tribe-related-events-thumbnail hover-type-<?php echo Aione()->settings->get( 'ec_hover_type' ); ?>">
