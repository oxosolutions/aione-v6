...
class Oxo_Widget_Flickr extends WP_Widget {

	function __construct() {

		$widget_ops = array(
			'classname'   => 'flickr',
			'description' => __( 'The most recent photos from flickr.', 'Aione' )
		);
		$control_ops = array( 'id_base' => 'flickr-widget' );

		parent::__construct( 'flickr-widget', 'Aione: Flickr', $widget_ops, $control_ops );
	...
	function form( $instance ) {
		...
		$defaults = array(
			'title'       => __( 'Photos from Flickr', 'Aione' ),
			'screen_name' => '',
			'number'      => 6,
			'api'         => 'c9d2c2fda03a2ff487cb4769dc0781ea'
		);
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'screen_name' ); ?>"><?php printf( __( 'Flickr ID (%sGet your flickr ID%s):', 'Aione' ), '<a href="' . $flickr_getid_url . '">', '</a>' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php _e( 'Number of photos to show:', 'Aione' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'api' ); ?>"><?php printf( __( 'API key (Use default or get your own from %sFlickr APP Garden%s):', 'Aione' ), '<a href="' . $flickr_apply_url . '">', '</a>' ); ?></label>
			...
			<small><?php printf( __( 'Default key is: %s', 'Aione' ), 'c9d2c2fda03a2ff487cb4769dc0781ea' ); ?></small>
		</p>
