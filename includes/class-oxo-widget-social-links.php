...
class Oxo_Widget_Social_Links extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct( 'social_links-widget', 'Aione: Social Links', $widget_ops, $control_ops );
	...
	function widget( $args, $instance ) {
		...
		$add_class = '';
		$style     = '';
		$nofollow  = ( Aione()->theme_options[ 'nofollow_social_links' ] ) ? ' rel="nofollow"' : '';

		if ( ! isset( $instance['tooltip_pos'] ) || ! $instance['tooltip_pos'] ) {
			$instance['tooltip_pos'] = Aione()->settings->get( 'social_links_tooltip_placement' );
		}

		if ( ! isset( $instance['icon_color'] ) || ! $instance['icon_color'] ) {
			$instance['icon_color'] = Aione()->settings->get( 'social_links_icon_color' );
		}

		if ( ! isset( $instance['boxed_icon'] ) || ! $instance['boxed_icon'] ) {
			$instance['boxed_icon'] = Aione()->settings->get( 'social_links_boxed' );
		}

		if ( ! isset( $instance['boxed_color'] ) || ! $instance['boxed_color'] ) {
			$instance['boxed_color'] = Aione()->settings->get( 'social_links_box_color' );
		}

		if ( ! isset( $instance['boxed_icon_radius'] ) || ! $instance['boxed_icon_radius'] ) {
			$instance['boxed_icon_radius'] = intval( Aione()->settings->get( 'social_links_boxed_radius' ) ) . 'px';
		}
		...
		<div class="oxo-social-networks<?php echo $add_class; ?>">
			<div class="oxo-social-networks-wrapper">
				...
				<?php foreach ( $social_networks as $name => $value ) : ?>
					...
					<?php if ( $instance[ $name ] ) : ?>
						...
						<?php if ( 'none' != strtolower( $instance['tooltip_pos'] ) ) : ?>
							<a class="oxo-social-network-icon oxo-tooltip oxo-<?php echo $value; ?> oxo-icon-<?php echo $value; ?>" href="<?php echo $instance[ $name ]; ?>" data-placement="<?php echo strtolower( $instance['tooltip_pos'] ); ?>" data-title="<?php echo ucwords( $tooltip ); ?>" data-toggle="tooltip" data-original-title="" title="<?php echo ucwords( $tooltip ); ?>" <?php echo $nofollow; ?> target="<?php echo $instance['linktarget']; ?>" style="<?php echo $style; ?><?php echo $icon_style; ?><?php echo $box_style; ?>"></a>
						<?php else : ?>
							<a class="oxo-social-network-icon oxo-tooltip oxo-<?php echo $value; ?> oxo-icon-<?php echo $value; ?>" href="<?php echo $instance[ $name ]; ?>" title="<?php echo ucwords( $tooltip ); ?>" <?php echo $nofollow; ?> target="<?php echo $instance['linktarget']; ?>" style="<?php echo $style; ?><?php echo $icon_style; ?><?php echo $box_style; ?>"></a>
						<?php endif; ?>
				...
				<?php if ( isset( $instance['show_custom'] ) && 'Yes' == $instance['show_custom'] && Aione()->theme_options[ 'custom_icon_name' ] && Aione()->theme_options[ 'custom_icon_image' ] ) : ?>
					<a class="oxo-social-network-icon oxo-tooltip" target="<?php echo $instance['linktarget']; ?>" href="<?php echo Aione()->theme_options[ 'custom_icon_link' ]; ?>"<?php echo $nofollow; ?> data-placement="<?php echo strtolower( $instance['tooltip_pos'] ); ?>" data-title="<?php echo Aione()->theme_options[ 'custom_icon_name' ]; ?>" data-toggle="tooltip" data-original-title="" title="" style="<?php echo $style; ?>"><img src="<?php echo Aione()->theme_options[ 'custom_icon_image' ]; ?>" alt="<?php echo Aione()->theme_options[ 'custom_icon_name' ]; ?>" /></a>
				<?php endif; ?>
			</div>
		</div>
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'linktarget' ); ?>"><?php _e( 'Link Target:', 'Aione' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'icons_font_size' ); ?>"><?php _e( 'Icons Font Size:', 'Aione' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'icon_color' ); ?>"><?php _e( 'Icons Color Hex Code:', 'Aione' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'boxed_icon' ); ?>"><?php _e( 'Icons Boxed:', 'Aione' ); ?></label>
			<select id="<?php echo $this->get_field_id( 'boxed_icon' ); ?>" name="<?php echo $this->get_field_name( 'boxed_icon' ); ?>" class="widefat" style="width:100%;">
				<option value="No" <?php if ( 'No' == $instance['boxed_icon'] ) echo 'selected="selected"'; ?>><?php _e( 'No', 'Aione' ); ?></option>
				<option value="Yes" <?php if ( 'Yes' == $instance['boxed_icon'] ) echo 'selected="selected"'; ?>><?php _e( 'Yes', 'Aione' ); ?></option>
			</select>
		</p>

		<p>
			<label for="<?php echo $this->get_field_id( 'boxed_color' ); ?>"><?php _e( 'Boxed Icons Background Color Hex Code:', 'Aione' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'boxed_icon_radius' ); ?>"><?php _e( 'Boxed Icons Radius:', 'Aione' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'boxed_icon_padding' ); ?>"><?php _e( 'Boxed Icons Padding:', 'Aione' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'tooltip_pos' ); ?>"><?php _e( 'Tooltip Position:', 'Aione' ); ?></label>
			<select id="<?php echo $this->get_field_id( 'tooltip_pos' ); ?>" name="<?php echo $this->get_field_name( 'tooltip_pos' ); ?>" class="widefat" style="width:100%;">
				<option value="Top" <?php if ( 'Top' == $instance['tooltip_pos']) echo 'selected="selected"'; ?>><?php _e( 'Top', 'Aione' ); ?></option>
				<option value="Right" <?php if ( 'Right' == $instance['tooltip_pos']) echo 'selected="selected"'; ?>><?php _e( 'Right', 'Aione' ); ?></option>
				<option value="Bottom" <?php if ( 'Bottom' == $instance['tooltip_pos']) echo 'selected="selected"'; ?>><?php _e( 'Bottom', 'Aione' ); ?></option>
				<option value="Left" <?php if ( 'Left' == $instance['tooltip_pos']) echo 'selected="selected"'; ?>><?php _e( 'Left', 'Aione' ); ?></option>
				<option value="None" <?php if ( 'None' == $instance['tooltip_pos']) echo 'selected="selected"'; ?>><?php _e( 'None', 'Aione' ); ?></option>
			</select>
		</p>

		<p>
			<label for="<?php echo $this->get_field_id( 'show_custom' ); ?>"><?php _e( 'Show Custom Icon:', 'Aione' ); ?></label>
			<select id="<?php echo $this->get_field_id( 'show_custom' ); ?>" name="<?php echo $this->get_field_name( 'show_custom' ); ?>" class="widefat" style="width:100%;">
				<option value="No" <?php if ( 'No' == $instance['show_custom'] ) echo 'selected="selected"'; ?>><?php _e( 'No', 'Aione' ); ?></option>
				<option value="Yes" <?php if ( 'Yes' == $instance['show_custom'] ) echo 'selected="selected"'; ?>><?php _e( 'Yes', 'Aione' ); ?></option>
			</select>
		</p>

		<p>
			<label for="<?php echo $this->get_field_id( 'rss_link' ); ?>"><?php printf( __( '%s Link:', 'Aione' ), 'RSS' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'fb_link' ); ?>"><?php printf( __( '%s Link:', 'Aione' ), 'Facebook' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'twitter_link' ); ?>"><?php printf( __( '%s Link:', 'Aione' ), 'Twitter' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'dribbble_link' ); ?>"><?php printf( __( '%s Link:', 'Aione' ), 'Dribbble' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'google_link' ); ?>"><?php printf( __( '%s Link:', 'Aione' ), 'Google+' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'linkedin_link' ); ?>"><?php printf( __( '%s Link:', 'Aione' ), 'LinkedIn' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'blogger_link' ); ?>"><?php printf( __( '%s Link:', 'Aione' ), 'Blogger' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'tumblr_link' ); ?>"><?php printf( __( '%s Link:', 'Aione' ), 'Tumblr' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'reddit_link' ); ?>"><?php printf( __( '%s Link:', 'Aione' ), 'Reddit' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'yahoo_link' ); ?>"><?php printf( __( '%s Link:', 'Aione' ), 'Yahoo' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'deviantart_link' ); ?>"><?php printf( __( '%s Link:', 'Aione' ), 'Deviantart' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'vimeo_link' ); ?>"><?php printf( __( '%s Link:', 'Aione' ), 'Vimeo' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'youtube_link' ); ?>"><?php printf( __( '%s Link:', 'Aione' ), 'Youtube' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'pinterest_link' ); ?>"><?php printf( __( '%s Link:', 'Aione' ), 'Pinterest' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'digg_link' ); ?>"><?php printf( __( '%s Link:', 'Aione' ), 'Digg' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'flickr_link' ); ?>"><?php printf( __( '%s Link:', 'Aione' ), 'Flickr' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'forrst_link' ); ?>"><?php printf( __( '%s Link:', 'Aione' ), 'Forrst' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'myspace_link' ); ?>"><?php printf( __( '%s Link:', 'Aione' ), 'Myspace' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'skype_link' ); ?>"><?php printf( __( '%s Link:', 'Aione' ), 'Skype' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'instagram_link' ); ?>"><?php printf( __( '%s Link:', 'Aione' ), 'Instagram' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'vk_link' ); ?>"><?php printf( __( '%s Link:', 'Aione' ), 'VK' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'paypal_link' ); ?>"><?php printf( __( '%s Link:', 'Aione' ), 'PayPal' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'dropbox_link' ); ?>"><?php printf( __( '%s Link:', 'Aione' ), 'Dropbox' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'soundcloud_link' ); ?>"><?php printf( __( '%s Link:', 'Aione' ), 'Soundcloud' ); ?></label>
