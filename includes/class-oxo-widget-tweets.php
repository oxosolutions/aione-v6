...
class Oxo_Widget_Tweets extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct('tweets-widget', 'Aione: Twitter', $widget_ops, $control_ops);
	...
	public function widget( $args, $instance ) {
		...
		$widget_type			= isset( $instance['widget_type'] ) ? $instance['widget_type'] : 'aione_style';
		...
		$link_color				= isset( $instance['link_color'] ) ? $instance['link_color'] : Aione()->settings->get( 'link_color' );
		$border_color			= isset( $instance['border_color'] ) ? $instance['border_color'] : Aione()->settings->get( 'timeline_color' );
	...
	public function form( $instance ) {
		...
		$defaults = array(
			...
			'widget_id'				=> '',
			'widget_type'			=> 'aione_style',
			'width'					=> '',
			'height'				=> '',
			'theme'					=> 'light',
			'link_color'			=> Aione()->settings->get( 'link_color' ),
			'border_color'			=> Aione()->settings->get( 'timeline_color' ),
			'show_header'			=> 'on',
			'show_footer'			=> 'on',
			'show_borders'			=> 'on',
			'transparent_bg'		=> 'off'
		...
		$twitter_doc_url = 'https://oxosolutions.com/aione-doc/twitter-widget/';
		...
		<script type="text/javascript">
			...
			var $widget_type_select = jQuery( '#<?php echo $this->get_field_id( 'widget_type' ); ?>' );
				if ( $widget_type_select.val() == 'twitter_style' ) {
					$widget_type_select.parents( '.widget' ).find( '.aione_style' ).hide();
					$widget_type_select.parents( '.widget' ).find( '.twitter_style' ).show();
					$widget_type_select.parents( '.widget' ).find( '.general_option' ).show();
				} else if( $widget_type_select.val() == 'aione_style' ) {
					$widget_type_select.parents( '.widget' ).find( '.aione_style' ).show();
					$widget_type_select.parents( '.widget' ).find( '.general_option' ).show();
				...
				jQuery( '.widget-type-selector' ).change( function() {
					if ( jQuery( this ).val() == 'twitter_style' ) {
						jQuery( this ).parents( '.widget' ).find( '.aione_style' ).hide();
						jQuery( this ).parents( '.widget' ).find( '.twitter_style' ).show();
						jQuery( this ).parents( '.widget' ).find( '.general_option' ).show();
					} else if( jQuery( this ).val() == 'aione_style' ) {
						jQuery( this ).parents( '.widget' ).find( '.aione_style' ).show();
						jQuery( this ).parents( '.widget' ).find( '.general_option' ).show();
		...
		<p><?php _e( 'For general setup information or information on how to setup a Twitter App or a Twitter Widget on twitter.com, please see our documentation:', 'Aione' ); ?> <a href="<?php echo $twitter_doc_url; ?>" target="_blank"><?php _e( 'How to setup the Aione twitter widget.', 'Aione' ); ?></a></p>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'widget_type' ); ?>"><?php _e( 'Widget Style:', 'Aione' ); ?></label>
			<select id="<?php echo $this->get_field_id( 'widget_type' ); ?>" name="<?php echo $this->get_field_name( 'widget_type' ); ?>" class="widefat widget-type-selector" style="width:100%;">
				<option value="twitter_preconfig_style" <?php selected( $instance['widget_type'], 'twitter_preconfig_style' ); ?>><?php _e( 'Twitter Preconfigured Style', 'Aione' ); ?></option>
				<option value="twitter_style" <?php selected( $instance['widget_type'], 'twitter_style' ); ?>><?php _e( 'Twitter Style', 'Aione' ); ?></option>
				<option value="aione_style" <?php selected( $instance['widget_type'], 'aione_style' ); ?>><?php _e( 'Aione Style', 'Aione' ); ?></option>
			</select>
		</p>

		<p class="twitter_style widget_id">
			<label for="<?php echo $this->get_field_id( 'widget_id' ); ?>"><?php _e( 'Twitter Widget ID:', 'Aione' ); ?></label>
		...
		<p class="aione_style">
			<label for="<?php echo $this->get_field_id( 'consumer_key' ); ?>"><?php _e( 'Consumer Key:', 'Aione' ); ?></label>
		...
		<p class="aione_style">
			<label for="<?php echo $this->get_field_id( 'consumer_secret' ); ?>"><?php _e( 'Consumer Secret:', 'Aione' ); ?></label>
		...
		<p class="aione_style">
			<label for="<?php echo $this->get_field_id( 'access_token' ); ?>"><?php _e( 'Access Token:', 'Aione' ); ?></label>
		...
		<p class="aione_style">
			<label for="<?php echo $this->get_field_id( 'access_token_secret' ); ?>"><?php _e( 'Access Token Secret:', 'Aione' ); ?></label>
		...
		<p  class="aione_style">
			<label for="<?php echo $this->get_field_id( 'twitter_id' ); ?>"><?php _e( 'Twitter Username:', 'Aione' ); ?></label>
		...
		<p  class="general_option">
			<label for="<?php echo $this->get_field_id( 'count' ); ?>"><?php _e( 'Number of Tweet (max. 20 tweets possible):', 'Aione' ); ?></label>
		...
		<p class="twitter_style">
			<label for="<?php echo $this->get_field_id( 'width' ); ?>"><?php _e( 'Max. Width (has to be between 180 and 520):', 'Aione' ); ?></label>
		...
		<p class="twitter_style">
			<label for="<?php echo $this->get_field_id( 'height' ); ?>"><?php _e( 'Height (min. is 200):', 'Aione' ); ?></label>
		...
		<p class="twitter_style">
			<label for="<?php echo $this->get_field_id( 'theme' ); ?>"><?php _e( 'Color Scheme:', 'Aione' ); ?></label>
			<select id="<?php echo $this->get_field_id( 'theme' ); ?>" name="<?php echo $this->get_field_name( 'theme' ); ?>" class="widefat" style="width:100%;">
				<option value="light" <?php if ( 'light' == $instance['theme'] ) echo 'selected="selected"'; ?>><?php _e( 'Light', 'Aione' ); ?></option>
				<option value="dark" <?php if ( 'dark' == $instance['theme'] ) echo 'selected="selected"'; ?>><?php _e( 'Dark', 'Aione' ); ?></option>
			</select>
		</p>

		<p class="twitter_style">
			<label for="<?php echo $this->get_field_id( 'link_color' ); ?>"><?php _e( 'Link Color (leave empty for Theme default link color):', 'Aione' ); ?></label>
		...
		<p class="twitter_style">
			<label for="<?php echo $this->get_field_id( 'border_color' ); ?>"><?php _e( 'Border Color:', 'Aione' ); ?></label>
		...
		<p class="twitter_style">
			...
			<label for="<?php echo $this->get_field_id( 'show_header' ); ?>"><?php _e( 'Show Header', 'Aione' ); ?></label>
		</p>
		...
		<p class="twitter_style">
			...
			<label for="<?php echo $this->get_field_id( 'show_footer' ); ?>"><?php _e( 'Show Footer', 'Aione' ); ?></label>
		</p>
		...
		<p class="twitter_style">
			...
			<label for="<?php echo $this->get_field_id( 'show_borders' ); ?>"><?php _e( 'Show Borders', 'Aione' ); ?></label>
		</p>
		...
		<p class="twitter_style">
			...
			<label for="<?php echo $this->get_field_id( 'transparent_bg' ); ?>"><?php _e( 'Transparent Background', 'Aione' ); ?></label>
		</p>
