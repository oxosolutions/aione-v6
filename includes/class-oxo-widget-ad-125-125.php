...
class Oxo_Widget_Ad_125_125 extends WP_Widget {

	function __construct() {

		$widget_ops = array('classname' => 'ad_125_125', 'description' => 'Add 125x125 ads.');
		$control_ops = array('id_base' => 'ad_125_125-widget');
		parent::__construct('ad_125_125-widget', 'Aione: 125x125 Ads', $widget_ops, $control_ops);
	...
	function form( $instance ) {
		...
		<p><strong><?php printf( __( 'Ad %s', 'Aione' ), '1' ); ?></strong></p>
		<p>
			<label for="<?php echo $this->get_field_id( 'ad_125_img_1' ); ?>"><?php _e( 'Image Ad Link:', 'Aione' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'ad_125_link_1' ); ?>"><?php _e( 'Ad Link:', 'Aione' ); ?></label>
		...
		<p><strong><?php printf( __( 'Ad %s', 'Aione' ), '2' ); ?></strong></p>
		<p>
			<label for="<?php echo $this->get_field_id( 'ad_125_img_2' ); ?>"><?php _e( 'Image Ad Link:', 'Aione' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'ad_125_link_2' ); ?>"><?php _e( 'Ad Link:', 'Aione' ); ?></label>
		...
		<p><strong><?php printf( __( 'Ad %s', 'Aione' ), '3' ); ?></strong></p>
		<p>
			<label for="<?php echo $this->get_field_id( 'ad_125_img_3' ); ?>"><?php _e( 'Image Ad Link:', 'Aione' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'ad_125_link_3' ); ?>"><?php _e( 'Ad Link:', 'Aione' ); ?></label>
		...
		<p><strong><?php printf( __( 'Ad %s', 'Aione' ), '4' ); ?></strong></p>
		<p>
			<label for="<?php echo $this->get_field_id( 'ad_125_img_4' ); ?>"><?php _e( 'Image Ad Link:', 'Aione' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'ad_125_link_4' ); ?>"><?php _e( 'Ad Link:', 'Aione' ); ?></label>
