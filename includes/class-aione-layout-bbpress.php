 ...
 */
class Aione_Layout_bbPress extends Aione_Layout {
	...
	public function add_bbp_header() {
		?>
		<div class="bbp-header oxo-bbp-header">
	...
	public function add_author_post_date_count_ip() {
		...
		<div class="bbps-post-count"><?php printf( __( 'Post count: %s', 'Aione' ), bbp_get_user_reply_count_raw( bbp_get_reply_author_id() ) + bbp_get_user_topic_count_raw( bbp_get_reply_author_id() ) ); ?></div>

		<?php if ( bbp_is_user_keymaster() ) : ?>

			<?php do_action( 'bbp_theme_before_topic_author_admin_details' ); ?>

			<div class="bbp-reply-ip oxo-reply-id"><?php bbp_author_ip( bbp_get_topic_id() ); ?></div>
			...
			<form role="search" method="get" class="bbp-search-form seach-form searchform" action="<?php bbp_search_url(); ?>">
				<div class="search-table">
					...
					<div class="search-button">
						<input tabindex="<?php bbp_tab_index(); ?>" class="oxo-button button submit" type="submit" id="bbp_search_submit" value="&#xf002;" />
					</div>
				</div>
			</form>
		</div>
	...
	/**
	 * Filter forum pagination links to get them Aione style
	 *
	 * @ return string Aione style pagination mark up
	 */
	public function get_forum_pagination_links() {
		...
		$pagination_links = str_replace( '&larr;', '<span class="page-text">' . __( 'Previous', 'Aione' ) . '</span><span class="page-prev"></span>', $pagination_links );
		$pagination_links = str_replace( '&rarr;', '<span class="page-text">' . __( 'Next', 'Aione' ) . '</span><span class="page-next"></span>', $pagination_links );

		return $pagination_links;
	}

	/**
	 * Filter topic pagination links to get them Aione style
	 *
	 * @ return string Aione style pagination mark up
	 */
	...
	/**
	 * Filter search pagination links to get them Aione style
	 *
	 * @ return string Aione style pagination mark up
	 */
