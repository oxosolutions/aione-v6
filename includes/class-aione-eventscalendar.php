...
class Aione_EventsCalendar {
	...
	public function before_the_title() {
		echo '<div class="oxo-events-before-title">';
	}
	...
	public function set_mobile_breakpoint() {
		return intval( Aione()->settings->get( 'content_break_point' ) );
	}

	public static function render_single_event_title() {
		$event_id = get_the_ID();
		?>
		<div class="oxo-events-single-title-content">
