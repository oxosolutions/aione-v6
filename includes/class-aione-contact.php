...
// 		// Setup reCaptcha
// 		if ( Aione()->settings->get( 'recaptcha_public' ) && Aione()->settings->get( 'recaptcha_private' ) && ! function_exists( 'recaptcha_get_html' ) ) {

// 			require_once( trailingslashit( get_template_directory() ) . 'framework/recaptchalib.php' );
// 			// Instantiate ReCaptcha object
// 			$re_captcha = new ReCaptcha( Aione()->settings->get( 'recaptcha_private' ) );
...
// 		$emailTo = Aione()->settings->get( 'email_address' ); //Put your own email address here
