...
class Oxo_Widget_Recent_Works extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct('recent_works-widget', 'Aione: Recent Works', $widget_ops, $control_ops);
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php _e( 'Number of items to show:', 'Aione' ); ?></label>
