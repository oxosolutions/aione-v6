			...
			#post-<?php echo $post->ID; ?> .oxo-post-slideshow{
			...
			#post-<?php echo $post->ID; ?> .oxo-post-slideshow,
			#post-<?php echo $post->ID; ?> .oxo-post-slideshow .oxo-image-wrapper img{
			...
			<?php
			if( ! Aione()->template->has_sidebar() || get_post_meta($post->ID, 'pyre_full_width', true) == 'yes' ) {
				$size = 'full';
			} else {
				$size = 'blog-large';
			}
