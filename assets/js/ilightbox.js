...
(function($, window, undefined) {
	...
	var extensions = {
		...
		// Events
		// OXOSolutions edit for Aione theme: remove the .iLightBox namespace from click event to avoid different button errors
	...
	iLightBox.prototype = {
		...
		attachItems: function() {
			...
			/* Edit by OXOSolutions to fix the total amount of items issue on refresh */
			if( iL.vars ) {
		...
		normalizeItems: function() {
			...
			$.each(iL.items, function(key, val) {
				...
				if (!options.width || !options.height) {
					// OXOSolutions edit for Aione theme; set width from 1280x700 (100% for iframe) to the theme option values
		...
		loadSwitcher: function(obj, holder, item, opt) {
			...
			switch (obj.type) {
				...
				case 'iframe':
					// OXOSolutions edit for Aione theme: added possibility to add width and height as part of query string for videos
		...
		doFullscreen: function() {
			...
			if (opts.fullAlone) {
				var currentHolder = vars.holder,
					...
					// OXOSolutions edit for Aione theme: fix fullscreen issues with second slide and nav arrows
		...
		availPlugins: function() {
			...
			iL.plugins = {
				flash: false, // fix for issue #1750 by Aione
		...
		addContent: function(element, obj) {
			...
			switch (obj.type) {
				...
				case 'iframe':
					// OXOSolutions edit for Aione theme: added possibility to add autoplay and rel as part of query string for videos
					var $query_array = obj.URL.substring( obj.URL.indexOf( '?' ) + 1 ).split( '&' ),
						$query_object = {},
						$query_string = '?';
					...
					// OXOSolutions edit for Aione theme: short url support for videos
	...
	function removeHash() {
		...
		// OXOSolutions edit for Aione theme: the original removeHash approach makes old IE versions shake. So we just use a HTML5 browser feature for removal and leave old IEs unaltered
	...
	function getExtension(URL) {
		var ext = ( URL ) ? URL.split('.').pop().toLowerCase() : '',
			extra = ext.indexOf('?') !== -1 ? '?' + ext.split('?').pop() : ''; // OXOSolutions edit for Aione theme: added the ? sign in front of the extra string to ensure it works correctly
	...
	(function() {
		...
		$.each(("touchstart touchmove touchend " +
			"tap taphold " +
			"swipeleft swiperight " + // OXOSolutions edit for Aione theme: delete "swipe" keyword
