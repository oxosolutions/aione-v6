<?php global $woocommerce, $theme_options; ?>
<div class='top-menu'>
	<ul id="snav" class="menu">
		...
		<?php if($theme_options['woocommerce_acc_link_top_nav']): ?>
		<li class="my-account">
			<a href="<?php echo get_permalink(get_option('woocommerce_myaccount_page_id')); ?>"><?php _e('My Account', 'aione'); ?></a>
		...
		<?php endif; ?>
		<?php if($theme_options['woocommerce_cart_link_top_nav']): ?>
		<li class="cart">
			<?php //var_dump($woocommerce->cart); ?>
			<?php if(!$woocommerce->cart->cart_contents_count): ?>
			<a class="empty-cart" href="<?php echo get_permalink(get_option('woocommerce_cart_page_id')); ?>"><?php _e('Cart', 'aione'); ?></a>
			<?php else: ?>
			<a href="<?php echo get_permalink(get_option('woocommerce_cart_page_id')); ?>"><?php echo $woocommerce->cart->cart_contents_count; ?> <?php _e('Item(s)', 'aione'); ?> - <?php echo woocommerce_price($woocommerce->cart->subtotal); ?></a>
