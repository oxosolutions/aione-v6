<div class="wrap" id="of_container">
	...
	<div id="of-popup-fail" class="of-save-popup">
		<div class="of-fail-wrapper">
			<div class="of-save-fail"><?php _e('Error!', 'Aione'); ?></div><div class="of-fail-msg">Error Message</div>
		</div>
	</div>
	...
	<h1 class="screen-reader-text"><?php _e( 'Theme Options', 'Aione' ); ?></h1>
	<form id="of_form" method="post" action="<?php echo esc_attr( $_SERVER['REQUEST_URI'] ) ?>" enctype="multipart/form-data" >
		...
		<div id="header">
			...
			?>
			<div class="docs">
				<a href="<?php echo $theme_oxo_url . 'support/documentation/aione-documentation/'; ?>" target="_blank"><?php _e('Online Documentation', 'Aione'); ?></a><span class="link_sep">|</span><a href="<?php echo $theme_oxo_url . 'support/'; ?>" target="_blank"><?php _e('Support Center', 'Aione'); ?></a>
			</div>
			<?php // End Aione Edit ?>
