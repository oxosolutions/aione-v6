...
function optionsframework_admin_init()
{
	...
	/**
	 * In Aione 3.7, we introduced backgroundcolor type.
	 *
...
function optionsframework_add_admin() {
	...
	$of_page = add_theme_page( THEMENAME, __( 'Theme Options', 'Aione' ), 'edit_theme_options', 'optionsframework', 'optionsframework_options_page');
...
function of_ajax_callback()
{
	...
	if($save_type == 'upload')
	{
		...
		$uploaded_file = wp_handle_upload($filename,$override);
		 ...
		 if(!empty($uploaded_file['error'])) { echo sprintf(__('Upload Error: %s', 'Aione'), $uploaded_file['error']); }
