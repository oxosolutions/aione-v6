...
function of_save_options($data, $key = null) {
	...
	update_option( 'aione_disable_builder', Aione()->theme_options['disable_builder'] );
	update_option( 'aione_disable_encoding', Aione()->theme_options['disable_code_block_encoding'] );
	do_action( 'aione_save_options' );
}
