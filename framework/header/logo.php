...
<?php if($theme_options['header_show_logo']): ?>
    <div class="logo" class="logo" data-margin-right="<?php echo $theme_options['margin_logo_right']; ?>" data-margin-left="<?php echo $theme_options['margin_logo_left']; ?>" data-margin-top="<?php echo $theme_options['margin_logo_top']; ?>" data-margin-bottom="<?php echo $theme_options['margin_logo_bottom']; ?>" style="margin-right:<?php echo $theme_options['margin_logo_right']; ?>;margin-top:<?php echo $theme_options['margin_logo_top']; ?>;margin-left:<?php echo $theme_options['margin_logo_left']; ?>;margin-bottom:<?php echo $theme_options['margin_logo_bottom']; ?>;">
...
<?php if($theme_options['header_show_site_title'] || $theme_options['header_show_tagline'] ): ?>
    <div id="logo_text" class="logo-text">
        <?php if($theme_options['header_show_site_title']){
            ...
            if(!empty($site_title)):?>
                <div id="site_title" class="site-title"><a id="site_name" class="site-name" href="<?php echo home_url( '/' ); ?>"><?php bloginfo('name'); ?></a></div>
            <?php endif; }?>
        <?php if($theme_options['header_show_tagline']){
            $site_desc = get_bloginfo( 'description' );
            if(!empty($site_desc)):?>
                <div id="site_description" class="site-description"><?php bloginfo( 'description' ); ?></div>
            <?php endif; }?>
    </div>
<?php endif; ?>