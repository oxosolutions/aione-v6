...
class sidebar_generator {
	...
	public static function add_sidebar(){
		...
		if(isset($sidebars[$id])){
			die("alert('" . __( 'Widget Section already exists, please use a different name.', 'Aione' ) . "')");
		}
	...
	public static function remove_sidebar(){
		...
		$no_widget_text = __( 'No Widget Sections defined.', 'Aione' );
	...
	public static function admin_page(){
		...
		<script>
			function remove_sidebar_link(name,num){
				answer = confirm("<?php _e( 'Are you sure you want to remove', 'Aione' ); ?> " + name + "?\n<?php _e( 'This will remove any widgets you have assigned to this widget section.', 'Aione' ); ?>");
				if(answer){
					//alert('AJAX REMOVE');
			...
			function add_sidebar_link(){
				var sidebar_name = prompt("<?php _e( 'Widget Section Name:', 'Aione' ); ?>","");
				//alert(sidebar_name);
		...
		<div class="wrap">
			<h2><?php _e( 'Widget Sections:', 'Aione' ); ?></h2>
			<br />
			<table class="widefat page" id="sbg_table" style="width:600px;">
				<tr>
					<th><?php _e( 'Widget Section Name', 'Aione' ); ?></th>
					<th><?php _e( 'CSS Class', 'Aione' ); ?></th>
					<th><?php _e( 'Remove', 'Aione' ); ?></th>
				</tr>
				<?php
				$sidebars = sidebar_generator::get_sidebars();
				if(is_array($sidebars) && !empty($sidebars)){
				...
				<tr class="<?php echo $alt; ?>">
					...
					<td><a href="javascript:void(0);" onclick="return remove_sidebar_link('<?php echo $sidebar; ?>',<?php echo $cnt+1; ?>);" title="<?php _e( 'Remove this Widget Section', 'Aione' ); ?>">remove</a></td>
				</tr>
				<?php
						$cnt++;
					}
					...
					<tr id="no-widget-sections">
						<td colspan="3"><?php _e( 'No Widget Sections defined.', 'Aione' ); ?></td>
					</tr>
					<?php
				}
				?>
			...
			<div class="add_sidebar">
				<a href="javascript:void(0);" onclick="return add_sidebar_link()" title="<?php _e( 'Add New Widget Section', 'Aione' ); ?>" class="button-primary"><?php _e( 'Add New Widget Section', 'Aione' ); ?></a>
	...
	public static function edit_form(){
		...
		?>
			<div class="pyre_metabox_field">
					...
					<div class="pyre_desc">
						<label><?php _e('Select Sidebar 1:', 'Aione'); ?></label>
						<p><?php _e('Select sidebar 1 that will display on this page. Choose "No Sidebar" for full width.', 'Aione'); ?></p>
					</div>
			...
			<div class="pyre_metabox_field">
					<input name="sbg_edit" type="hidden" value="sbg_edit" />
					<div class="pyre_desc">
						<label><?php _e('Select Sidebar 2:', 'Aione'); ?></label>
						<p><?php _e('Select sidebar 2 that will display on this page. Sidebar 2 can only be used if sidebar 1 is selected.', 'Aione'); ?></p>
					</div>
					<div class="pyre_field">
					<?php
					global $wp_registered_sidebars;
