...
add_action( 'wp_ajax_oxo_import_demo_data', 'oxo_importer' );
function oxo_importer() {
	global $wpdb;
	...
	if ( current_user_can( 'manage_options' ) ) {
		...
		if ( class_exists( 'WP_Importer' ) && class_exists( 'WP_Import' ) ) { // check for main import class and wp import class
			...
			switch($demo_type) {
				case 'agency':
					$shop_demo = false;
					$theme_xml_file = get_template_directory() . '/framework/plugins/importer/agency_demo/aione.xml';
					...
					$fs_exists = true;
					$fs_url = get_template_directory() . '/framework/plugins/importer/agency_demo/oxo_slider.zip';
				break;
				case 'app':
					$shop_demo = false;
					$theme_xml_file = get_template_directory() . '/framework/plugins/importer/app_demo/aione.xml';
					...
					$fs_exists = true;
					$fs_url = get_template_directory() . '/framework/plugins/importer/app_demo/oxo_slider.zip';
				break;
				case 'travel':
					$shop_demo = false;
					$theme_xml_file = get_template_directory() . '/framework/plugins/importer/travel_demo/aione.xml';
					...
					$fs_exists = true;
					$fs_url = get_template_directory() . '/framework/plugins/importer/travel_demo/oxo_slider.zip';
				break;
				case 'cafe':
					$shop_demo = false;
					$theme_xml_file = get_template_directory() . '/framework/plugins/importer/cafe_demo/aione.xml';
					...
					$fs_exists = true;
					$fs_url = get_template_directory() . '/framework/plugins/importer/cafe_demo/oxo_slider.zip';
				break;
				case 'fashion':
					$shop_demo = false;
					$theme_xml_file = get_template_directory() . '/framework/plugins/importer/fashion_demo/aione.xml';
					...
					$fs_exists = true;
					$fs_url = get_template_directory() . '/framework/plugins/importer/fashion_demo/oxo_slider.zip';
				break;
				case 'architecture':
					$shop_demo = false;
					$theme_xml_file = get_template_directory() . '/framework/plugins/importer/architecture_demo/aione.xml';
					...
					$fs_exists = true;
					$fs_url = get_template_directory() . '/framework/plugins/importer/architecture_demo/oxo_slider.zip';
				break;
				case 'hosting':
					$shop_demo = false;
					$theme_xml_file = get_template_directory() . '/framework/plugins/importer/hosting_demo/aione.xml';
					...
					$fs_exists = true;
					$fs_url = get_template_directory() . '/framework/plugins/importer/hosting_demo/oxo_slider.zip';
				break;
				case 'hotel':
					$shop_demo = false;
					$theme_xml_file = get_template_directory() . '/framework/plugins/importer/hotel_demo/aione.xml';
					...
					$fs_exists = true;
					$fs_url = get_template_directory() . '/framework/plugins/importer/hotel_demo/oxo_slider.zip';
				break;
				case 'law':
					$shop_demo = false;
					$theme_xml_file = get_template_directory() . '/framework/plugins/importer/law_demo/aione.xml';
					...
					$fs_exists = true;
					$fs_url = get_template_directory() . '/framework/plugins/importer/law_demo/oxo_slider.zip';
				break;
				case 'lifestyle':
					$shop_demo = false;
					$theme_xml_file = get_template_directory() . '/framework/plugins/importer/lifestyle_demo/aione.xml';
					...
					$fs_exists = true;
					$fs_url = get_template_directory() . '/framework/plugins/importer/lifestyle_demo/oxo_slider.zip';
				break;
				case 'church':
					$shop_demo = false;
					$theme_xml_file = get_template_directory() . '/framework/plugins/importer/church_demo/aione.xml';
					...
					$fs_exists = true;
					$fs_url = get_template_directory() . '/framework/plugins/importer/church_demo/oxo_slider.zip';
				break;
				case 'gym':
					$shop_demo = false;
					$theme_xml_file = get_template_directory() . '/framework/plugins/importer/gym_demo/aione.xml';
					...
					$fs_exists = true;
					$fs_url = get_template_directory() . '/framework/plugins/importer/gym_demo/oxo_slider.zip';
				break;
				case 'modern_shop':
					// is a shop demo?
					$shop_demo = true;
					...
					$woo_xml = get_template_directory() . '/framework/plugins/importer/modern_shop_demo/aione.xml';

					$theme_xml_file = get_template_directory() . '/framework/plugins/importer/modern_shop_demo/aione.xml';
					...
					$fs_exists = true;
					$fs_url = get_template_directory() . '/framework/plugins/importer/modern_shop_demo/oxo_slider.zip';
				break;
				case 'classic_shop':
					// is a shop demo?
					$shop_demo = true;
					...
					$woo_xml = get_template_directory() . '/framework/plugins/importer/classic_shop_demo/aione.xml';

					$theme_xml_file = get_template_directory() . '/framework/plugins/importer/classic_shop_demo/aione.xml';
					...
					$fs_exists = true;
					$fs_url = get_template_directory() . '/framework/plugins/importer/classic_shop_demo/oxo_slider.zip';
				break;
				...
				// is a shop demo?
					...
					$woo_xml = get_template_directory() . '/framework/plugins/importer/landing_product_demo/aione.xml';

					$theme_xml_file = get_template_directory() . '/framework/plugins/importer/landing_product_demo/aione.xml';
				...
				case 'forum':
					$shop_demo = false;
					$theme_xml_file = get_template_directory() . '/framework/plugins/importer/forum_demo/aione.xml';
					...
					$fs_exists = true;
					$fs_url = get_template_directory() . '/framework/plugins/importer/forum_demo/oxo_slider.zip';
				break;
				default:
					// is a shop demo?
					$shop_demo = true;
					...
					$woo_xml = get_template_directory() . '/framework/plugins/importer/classic_demo/aione.xml';

					$theme_xml_file = get_template_directory() . '/framework/plugins/importer/classic_demo/aione.xml';
					...
					$fs_exists = true;
					$fs_url = get_template_directory() . '/framework/plugins/importer/classic_demo/oxo_slider.zip';
			}
			...
			if( isset( $widgets_file ) && $widgets_file ) {
				...
				$import_widgets = oxo_import_widget_data( $widget_data );
			}
			...
			if( function_exists( 'layerslider_import_sample_slider' ) && $layerslider_exists == true ) { // if layerslider is activated
				...
				$layer_files = oxo_get_import_files( $layer_directory, 'zip' );
			...
			if( class_exists('UniteFunctionsRev') && $revslider_exists == true ) { // if revslider is activated
				$rev_files = oxo_get_import_files( $rev_directory, 'zip' );
			...
			update_option( 'aione_imported_demo', 'true' );
...
function oxo_import_widget_data( $widget_data ) {
	...
	oxo_parse_import_data( $sidebar_data );
}

function oxo_parse_import_data( $import_array ) {
	...
	foreach ( $sidebars_data as $import_sidebar => $import_widgets ) :
		...
		foreach ( $import_widgets as $import_widget ) :
			...
			if ( isset( $wp_registered_sidebars[$import_sidebar] ) ) :
				...
				$new_widget_name = oxo_get_new_widget_name( $title, $index );
...
function oxo_get_new_widget_name( $widget_name, $widget_index ) {
	$current_sidebars = get_option( 'sidebars_widgets' );
...
function oxo_slider_delete_dir($dirPath) {
    if (! is_dir($dirPath)) {
    ...
    $files = oxo_get_import_files( $dirPath, '*' );
...
*/
function oxo_get_import_files( $directory, $filetype ) {
