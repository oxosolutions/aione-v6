...
<?php
	...
	function process_menu_item( $item ) {
		...
		// OXOSolutions edit for Aione theme: make sure all custom menu fields are imported correctly
		...
		foreach ( $field_name_suffix as $suffix ) {
			$key = '_menu_item_oxo_' . $suffix;
			if ( isset( $$key ) ) {
				update_post_meta( $id, '_menu_item_oxo_' . $suffix , $$key );
			}
		}
		// end edit
